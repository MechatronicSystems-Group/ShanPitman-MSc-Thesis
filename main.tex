...
\begin{tabular*}{\textwidth}{@{} l @{\extracolsep{\fill}} r}
    \textbf{Author:} \theauthor &  \researchgroup \\
...
\include{Chapters/Systems_Specifications} % User requirements + specific goals
\include{Chapters/TrackingAlgorithm} % Motion Capture Algorithm + Hardware
\include{Chapters/OCP} % Optimal Camera Placement and Genetic Algorithm 
